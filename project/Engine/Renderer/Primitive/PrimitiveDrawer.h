...
public:
	...
	void DrawBoneLine3d(const CalyxEngine::Vector3& start, const CalyxEngine::Vector3& end, const CalyxEngine::Vector4& color);
...
private:
	...
	std::unique_ptr<LineDrawer> boneLineDrawer_;
