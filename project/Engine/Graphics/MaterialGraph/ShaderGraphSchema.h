			...
			schema.nodes = {
				...
				{"ToonMaster",
				 ...
				 {{"Base Color", NodeValueType::Color, ShaderGraphPinRole::Input},
				  {"Emissive", NodeValueType::Color, ShaderGraphPinRole::Input},
				  {"Emissive Intensity", NodeValueType::Float, ShaderGraphPinRole::Input},
				  ...
				  {"Normal Map", NodeValueType::Color, ShaderGraphPinRole::Input},
				  {"Normal Strength", NodeValueType::Float, ShaderGraphPinRole::Input},
