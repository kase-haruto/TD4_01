...
void TestScene::Initialize(){
	...
	std::string sceneFilePath = "Resources/Assets/Scenes/test.scene";

	SceneSerializer::Load(*sceneContext_, sceneFilePath);

	sceneContext_->SetSceneFilePath(sceneFilePath);
